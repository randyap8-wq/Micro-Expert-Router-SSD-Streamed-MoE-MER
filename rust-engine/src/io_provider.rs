...
impl NvmeStorage {
    ...
    fn read_at_with_retries(
        ...
        offset: u64,
        dst: &mut [u8],
        mut timing: Option<&mut crate::gpu_native_source_order_straggler_production::RawRead>,
    ) -> io::Result<usize> {
    ...
    pub(crate) async fn read_expert_observed(
        ...
        mut observation: Option<&mut crate::gpu_native_source_order_straggler_production::RawBatch>,
    ) -> io::Result<usize> {
...
mod hma1e_io_tests {
    use super::*;
    use crate::buffer_pool::BufferPool;
    use crate::gpu_native_source_order_straggler_production::{RawBatch, WIDTH};
    ...
    #[tokio::test(flavor = "multi_thread", worker_threads = 2)]
    async fn hma1e_actual_control_single_and_batch_disabled_equivalence() {
    ...
    #[tokio::test(flavor = "multi_thread", worker_threads = 2)]
    async fn hma1e_actual_treatment_workers_portable_preproved_fixture() {
    ...
    #[tokio::test(flavor = "multi_thread", worker_threads = 2)]
    async fn hma1e_error_order_and_failed_wrapper_capture_preserve_retry_semantics() {
        let fixture = Fixture::new();
        fixture.file(4, 4095);
        fixture.file(2, 4094);
        let pool = BufferPool::new(2, 4096, 4096);
